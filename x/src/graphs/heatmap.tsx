...
export default function HeatMap(){
    ...
    const tableData = useContext<any>(HEATMAP)
    const svgRef = useRef<SVGSVGElement|null>(null)
    const [pic, setPic] = useState<any>(samplePic)
    ...
    useEffect(()=>{
        ...
        function render(params:any, orig:any){
            ...
            if(coor){
                dots
                    ...
                    .attr('y', function(d:any){return d.y+8})
                ...
                inten 
                    ...
                    .enter()
                    .append('text')
                    .text(function(d:any){return `(${d.val})`})
