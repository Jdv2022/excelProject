...
export default function RenderVerticalBarGraph(){
    ...
    const verticalBarData = useContext(VERTICALBAR)
    ...
    useEffect(()=>{
        function VBG(){
            ...
            const AxisX = Object.keys(verticalBarData.data0[0])
            const AxisY = Object.keys(verticalBarData.data0[1])
            let temp = 0;
            ...
            xScale.domain(verticalBarData.data0.map(function(d) { return d[AxisX[0]] }))
