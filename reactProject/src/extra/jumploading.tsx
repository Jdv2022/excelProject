...
function JumpLoading() {
    ...
    const [locY, setLocY] = useState<any>({y1:150,y2:50})
    const [locY2, setLocY2] = useState<any>({y1:140,y2:50})
    const [locY3, setLocY3] = useState<any>({y1:130,y2:50})
    const [locY4, setLocY4] = useState<any>({y1:120,y2:50})
    const [locY5, setLocY5] = useState<any>({y1:110,y2:50})
    const [dir1, setDir1] = useState<boolean>(true)
    const [dir2, setDir2] = useState<boolean>(true)
    const [dir3, setDir3] = useState<boolean>(true)
    const [dir4, setDir4] = useState<boolean>(true)
    const [dir5, setDir5] = useState<boolean>(true)
    const [t1, setT1] = useState<any>(900)
    const [t2, setT2] = useState<any>(800)
    const [t3, setT3] = useState<any>(700)
    const [t4, setT4] = useState<any>(600)
    const [t5, setT5] = useState<any>(500)
    const color = '#068FFF'
    useEffect(() => {
